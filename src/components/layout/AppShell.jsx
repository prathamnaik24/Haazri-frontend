...
const NAV_CONFIG = {
  employee: [
    ...
    { path: '/app/resignation',  label: 'My Resignation', Icon: HRIcon },
  ...
  manager: [
    ...
    { path: '/app/manager-resignation', label: 'Team Resignations', Icon: HRIcon },
  ...
  org_admin: [
    ...
    { path: '/app/leave-approvals',    label: 'Leave Approvals',    Icon: ApprovalIcon },
    { path: '/app/hr-leaves',          label: 'HR Leaves',          Icon: HRIcon },
    { path: '/app/hr-resignation',     label: 'Resignations',       Icon: HRIcon },
