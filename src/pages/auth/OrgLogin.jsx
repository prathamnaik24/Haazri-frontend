    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ textAlign: 'center', display: 'flex', flexDirection: 'column', gap: 8 }}>
          <Link to="/register" style={{ fontSize: 13, color: '#1677B8', fontWeight: 500, textDecoration: 'none' }}>
            Register a new Organization
          </Link>
          <Link to="/employee-login" style={{ fontSize: 13, color: '#6b7280', textDecoration: 'none' }}>
            Are you an Employee? <span style={{ color: '#1677B8', fontWeight: 500 }}>Sign in here →</span>
          </Link>
        </div>
